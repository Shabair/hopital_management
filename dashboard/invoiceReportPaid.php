...
<center>
	...
	<div class="form-group">
		...
		<div class="col-md-5">
		  <input id="toDate" onchange="getReport()" class="form-control input-md"  type="date">   
		</div>
	</div>
</center>
</form>
...
<table class="table table-bordered" id="myTable">
		<thead>
			<tr>
			<center><td style='text-align:center;' colspan='9'><h3> Record of Paid Indoor Invoices</h3></td></center>
			</tr>
			<tr class="default">
				<th>Sr.</th>
				<th>Invoice ID</th>
